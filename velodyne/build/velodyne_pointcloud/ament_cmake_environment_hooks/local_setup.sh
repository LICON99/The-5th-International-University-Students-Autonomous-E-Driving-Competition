...
: ${AMENT_CURRENT_PREFIX:="/home/aiv/workspace/ros2/velodyne/install/velodyne_pointcloud"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/velodyne_pointcloud/environment/library_path.sh"
